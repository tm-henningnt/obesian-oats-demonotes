...
10-day road trip around Iceland's Ring Road (Route 1). Traveling with Marte. Flights and car rental booked!

### Logistics

- **Flights:** Oslo → Keflavík, July 10-20
- **Car:** Toyota RAV4 4WD from Blue Car Rental
- **Budget:** ~NOK 40,000 total (flights, car, accommodation, food, activities)
- **Accommodation:** Mix of guesthouses, Airbnb, and 2 nights camping
...
- [ ] Waterproof hiking jacket + pants
- [ ] Layers (wool base, fleece mid, shell outer)
- [ ] Sturdy hiking boots (broken in!)
- [ ] Swimsuit (hot springs!)
- [ ] Camera + extra batteries (cold drains them fast)
- [ ] Sunglasses and sunscreen (24h daylight in July)
- [ ] Cash (some places do not take cards)

### Bookings

- ✅ Flights booked (Norwegian, NOK 4,200 return)
- ✅ Car rental booked (NOK 8,500 for 10 days)
- ⏳ Whale watching — book 2 weeks before
- ⏳ Blue Lagoon — book 1 week before
- ⏳ Accommodation — 6 of 9 nights booked